...
class WriteThroughCacheFeatureFlagRepository implements FeatureFlagRepository
{
    ...
    {
        $cacheResult = $this->cacheRepository->save($featureFlag);
        $persistenceResult = $this->persistenceRepository->save($featureFlag);

        return $persistenceResult && $cacheResult;
    }
}
